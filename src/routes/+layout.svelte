...
>
  <div class="navbar-start">
    ...
    <a class="btn btn-ghost" href="/items">Items</a>
    <a class="btn btn-ghost" href="/stats">Stats</a>
  </div>

  <div class="navbar-end">
    <button id="github-button" aria-label="github-link">
      <a aria-labelledby="github-button" href="https://github.com/ao-analytics">
        <svg
          class="w-10 h-10"
