...
<div class="flex justify-center">
	<div class="w-11/12 space-y-2">
		<div class="w-full border shadow border-neutral stats stats-vertical md:stats-horizontal">
			<MarketOrderCount data={data.market_order_count}>
				<span slot="icon">
					<svg
				...
				<span slot="title"> Market Orders </span>
				<span slot="description"> Market Orders </span>
			</MarketOrderCount>
			<MarketOrderCount data={data.market_order_count_offer}>
				<span slot="icon">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						height="40"
				...
				<span slot="title"> Sell Orders </span>
				<span slot="description"> Sell Orders </span>
			</MarketOrderCount>
			<MarketOrderCount data={data.market_order_count_request}>
				<span slot="icon">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						height="40"
				...
				<span slot="title"> Buy Orders </span>
				<span slot="description"> Buy Orders </span>
			</MarketOrderCount>
		</div>
