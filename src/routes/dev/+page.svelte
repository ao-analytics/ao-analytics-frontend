...
<div class="flex justify-center">
	<div class="w-11/12 space-y-2">
		<div
			class="w-full border shadow border-neutral stats stats-vertical md:stats-horizontal"
		>
			{#await data.market_order_count then market_order_count}
				<div class="stat">
					...
					<div
						class="stat-value text-primary {data
							? ''
							: 'invisible'}"
					>
			...
			{#await data.market_order_count_offer then market_order_count_offer}
				<div class="stat">
					<div class="stat-figure text-primary">
						<svg
							xmlns="http://www.w3.org/2000/svg"
			...
			{#await data.market_order_count_request then market_order_count_request}
				<div class="stat">
					<div class="stat-figure text-primary">
						<svg
							xmlns="http://www.w3.org/2000/svg"
		...
		<div class="w-full border shadow border-neutral stats stats-vertical">
			{#if data.market_order_count_by_updated_at}
				<MarketOrderCountByUpdatedAt
					data={data.market_order_count_by_updated_at} 
					time_interval={$page.url.searchParams.get("time_interval")}
				/>
			{/if}
			...
			{#if data.market_order_count_by_updated_at}
				<MarketOrderCountByUpdatedAtAndLocation
					minAmount={10000}
					data={data.market_order_count_by_updated_at_and_location}
					time_interval={$page.url.searchParams.get("time_interval")}
				/>
			{/if}
		</div>
