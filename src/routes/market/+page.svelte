...
>
    ...
    <div class="dropdown join-item">
        <button type="button" class="btn join-item">Filters</button>
        <!-- svelte-ignore a11y-no-noninteractive-tabindex -->
        <div
            tabindex="0"
            class="z-[1] dropdown-content menu rounded-box join join-vertical"
        >
            <select
                    ...
                    {#each orders as order, i}
                        <tr class="hover:bg-base-200 h-14">
                            <td>
                                <img
                                    class="w-10"
                                    src={`https://render.albiononline.com/v1/item/${order.item_unique_name}.png?quality=${order.quality_level}&size=32`}
                                    alt="item"
                                />
                            </td>
                            <td>
